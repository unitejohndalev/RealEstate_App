...
//import image
import Image from "../assets/img/houses/house13lg.svg";
        ...
        <div className="lg:ml-8 xl:ml-[135px] flex flex-col items-center
         lg:items-start text-center lg:text-left justify-center flex-1 px-4 lg:px-0">
          ...
          <p className="max-w-[480px] mb-8">
            ...
            accusamus consequatur error voluptas voluptatibus odit ullam et
            debitis, doloribus cum.
          </p>
        </div>
        {/* image */}
        <div className="hidden flex-1 lg:flex justify-end items-end">
          <img className="rounded-tl-[150px]" src={Image} alt="" />
        </div>
      </div>
      <Search />
    </section>
